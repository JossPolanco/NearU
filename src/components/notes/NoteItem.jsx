...
export default function NoteItem({ note, onClick, onToggleFavorite }) {
    return (
        <div className="flex flex-col bg-base-100 dark:bg-base-900/40 p-3 pb-5 rounded-3xl shadow-xs border border-base-200/60 dark:border-base-800/40 w-full max-w-41.25 transition-transform duration-300 md:hover:scale-[1.02] active:scale-98 relative justify-self-center cursor-pointer"
            onClick={onClick}
        >
