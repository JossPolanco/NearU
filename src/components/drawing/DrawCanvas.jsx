...
export default function DrawCanvas() {
    ...
    const handleEraserModeChange = (mode) => {
        if (!eraseMode) {
            return;
        }
    ...
    return (
        <div className="not-prose flex flex-col gap-4 w-full">
                ...
                <div className="inline-flex flex-col gap-2">
                    ...
                    <div className="inline-flex rounded-md p-1 bg-fd-muted border border-fd-border w-fit">
                        <button
                            ...
                            className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${!eraseMode
            ...
            {/* Canvas Workspace */}
            <div className="relative overflow-hidden rounded-lg border border-fd-border bg-fd-card aspect-video min-h-60 shadow-sm">
                <ReactSketchCanvas
                    ref={canvasRef}
