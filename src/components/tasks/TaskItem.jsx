    ...
    return (
        ...
        >
            ...
            <div className="dropdown dropdown-end shrink-0" onClick={(e) => e.stopPropagation()}>
                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle btn-xs text-base-content/30 hover:text-primary hover:bg-base-200/50 transition-colors opacity-80 md:opacity-0 md:group-hover:opacity-100"
                ...
                {!isDeleting && (
                    <ul className="dropdown-content menu p-1.5 shadow-xl bg-base-100/95 dark:bg-base-950/95 border border-base-200 dark:border-base-800 rounded-2xl w-36 z-1 backdrop-blur" tabIndex={0}>
                        <li>
                            <button onClick={(e) => { e.stopPropagation(); e.currentTarget.blur(); onEdit(); }} className="flex items-center gap-2 text-xs font-medium py-2 rounded-xl text-base-content hover:bg-base-200/60 transition-colors">
