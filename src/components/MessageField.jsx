...
export default function MessageField({ replyingTo, onCancelReply }) {
    ...
    return (
        <div className="flex flex-col p-2 gap-2">
            ...
            {replyingTo && (
                <div className="flex items-center gap-2 bg-base-200 rounded-xl px-3 py-2 border-l-4 border-primary">
                    <CornerUpLeft size={16} className="text-primary shrink-0" />
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-primary font-semibold">Respondiendo</p>
