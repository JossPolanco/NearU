    ...
    return (
        <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-5 animate-fade-in pb-20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3.5 sm:gap-4">
                ...
                <button onClick={() => navigate('/diary')} className="btn btn-soft btn-primary col-span-2 min-h-35 sm:min-h-40 h-full w-full rounded-3xl p-5 flex flex-col justify-between items-start text-left group shadow-sm hover:shadow-md active:scale-[0.98] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/dates')} className="btn btn-soft btn-secondary col-span-1 row-span-2 min-h-55 h-full w-full rounded-3xl p-4 flex flex-col justify-between items-center text-center group shadow-sm hover:shadow-md active:scale-[0.98] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/notes')} className="btn btn-soft btn-info col-span-1 min-h-26.25 h-full w-full rounded-3xl p-3.5 flex flex-col items-center justify-center text-center gap-1.5 group shadow-sm hover:shadow-md active:scale-[0.97] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/tasks')} className="btn btn-soft btn-success col-span-1 min-h-26.25 h-full w-full rounded-3xl p-3.5 flex flex-col items-center justify-center text-center gap-1.5 group shadow-sm hover:shadow-md active:scale-[0.97] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/anniversaries')} className="btn btn-soft btn-warning col-span-1 min-h-26.25 h-full w-full rounded-3xl p-3.5 flex flex-col items-center justify-center text-center gap-1.5 group shadow-sm hover:shadow-md active:scale-[0.97] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/geolocation')} className="btn btn-soft btn-error col-span-1 min-h-26.25 h-full w-full rounded-3xl p-3.5 flex flex-col items-center justify-center text-center gap-1.5 group shadow-sm hover:shadow-md active:scale-[0.97] transition-all duration-200 border-none">
                ...
                <button onClick={() => navigate('/testing')} className="btn btn-soft btn-neutral col-span-1 min-h-23.75 h-full w-full rounded-3xl p-3 flex flex-col items-center justify-center text-center gap-1 group border-2 active:scale-[0.97] transition-all duration-200 opacity-80 hover:opacity-100">
                ...
                <button onClick={() => navigate('/config')} className="btn btn-soft btn-neutral col-span-1 min-h-23.75 h-full w-full rounded-3xl p-3 flex flex-col items-center justify-center text-center gap-1 group border-2 active:scale-[0.97] transition-all duration-200 opacity-80 hover:opacity-100">
